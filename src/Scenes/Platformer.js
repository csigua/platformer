class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        my.vfx.walking = this.add.particles(0, 6, "kenny-particles", {
            frame: ['trace_03.png', 'trace_02.png'],
            random: true,
    ...
    update() {
        ...
        if(my.sprite.player.body.blocked.down && Phaser.Input.Keyboard.JustDown(cursors.up)) {
            ...
            my.vfx.jump.x = my.sprite.player.body.x + my.sprite.player.body.displayWidth/2;
            my.vfx.jump.y = my.sprite.player.body.y + my.sprite.player.body.displayHeight;
            my.vfx.jump.start();
        }
